...
)  # (encuestas/config/settings/base.py - 3 = encuestas/)
APPS_DIR = ROOT_DIR.path("encuestas")
...
MIGRATION_MODULES = {"sites": "encuestas.contrib.sites.migrations"}
...
ADMINS = [("""David Chinchin""", "dmquito@hotmail.com")]
